...
**Reference List**
figure 1. (plot 1 + 2)
Leftwich, P.T. (no date) 5023Y:data science for biologysts, Chapter 3 loading data,Chapter 4 data wrangling part 1, Chapter 5 data wrangling part 2, Chapter 6 Data visualization with ggplot 2, Chapter 7 Markdown. Available at: https://ueabio.github.io/data-sci-v1/markdown.html (Accessed: 08 January 2024).
