...
##Figure 3. The bar chart demonstrates the symptomatic status of asymptomatic,symptomatic and unknown across the race populations of Black, White, Asian, Native American/Alaska native, Pacific Islander and Other. The symptomatic status is measured in number of observations.

**References**

Chang, W. (2024) R graphics cookbook, 2nd edition, 3.3 Making a Bar Graph of Counts. Available at: https://r-graphics.org/recipe-bar-graph-counts (Accessed: 08 January 2024). 

Holtz, Y. (no date) Basic barplot with GGPLOT2, – the R Graph Gallery. Available at: https://r-graph-gallery.com/218-basic-barplots-with-ggplot2.html (Accessed: 08 January 2024).

Leftwich, P.T. (no date) Chapter 7 Markdown: 5023Y, Chapter 7 Markdown | 5023Y. Available at: https://ueabio.github.io/data-sci-v1/markdown.html (Accessed: 08 January 2024). 

R.K. (2017) Bar plots, Quick-R: Bar Plots. Available at: https://www.statmethods.net/graphs/bar.html (Accessed: 08 January 2024). 